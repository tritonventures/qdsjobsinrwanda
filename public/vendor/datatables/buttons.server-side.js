(function($, DataTable) {
    ...
    DataTable.ext.buttons.candidatesFilter = {
        className: "btn btn-default btn-sm no-corner candidates-filter",

        text: function(dt) {
            return (
                '<i class="fa fa-filter mr-1"></i>' +
                dt.i18n("buttons.filter", "Filter")
            );
        },

        action: function(e, dt, button, config) {
            $("#admin-candidates-filter-modal").modal("show");
        }
    };
