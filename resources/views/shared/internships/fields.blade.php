<div class="row mx-0">
        ...
        <select name="company_id" class="custom-select text-capitalize">
            ...
            @foreach ($companies as $company)
                <option class="text-capitalize"
                    :selected="{{ isset($internship) ? ($internship->company_id == $company->id ? 'true' : 'false') : 'false' }}"
    ...
    <div class="form-group col-sm-6">
        ...
        <select name="nationality_id" class="custom-select text-capitalize">
            ...
            @foreach ($nationalities as $nationality)
                <option class="text-capitalize"
                    :selected="{{ isset($internship) ? ($internship->nationality_id == $nationality->id ? 'true' : 'false') : 'false' }}"
    ...
    <div class="form-group col-md-6 col-12">
        ...
        <multi-select :list="{{ $languages }}" name="languages"
            selected="{{ isset($internship->languages) ? $internship->languages : null }}" />
    </div>
    ...
    <div class="form-group col-sm-6">
        ...
        <select name="experience_id" class="custom-select text-capitalize">
            ...
            @foreach ($experiences as $experience)
                <option class="text-capitalize"
                    :selected="{{ isset($internship) ? ($internship->experience_id == $experience->id ? 'true' : 'false') : 'false' }}"
    ...
    <div class="form-group col-sm-6">
        ...
        <select name="education_id" class="custom-select text-capitalize">
            ...
            @foreach ($educations as $education)
                <option class="text-capitalize"
                    :selected="{{ isset($internship) ? ($internship->education_id == $education->id ? 'true' : 'false') : 'false' }}"
    ...
    <div class="form-group col-sm-6">
        ...
        <select name="proffession_id" class="custom-select text-capitalize">
            ...
            @foreach ($proffessions as $proffession)
                <option class="text-capitalize"
                    :selected="{{ isset($internship) ? ($internship->proffession_id == $proffession->id ? 'true' : 'false') : 'false' }}"
    ...
    <div class="form-group col-sm-6">
        ...
        <select name="salary_id" class="custom-select text-capitalize">
            ...
            @foreach ($salaries as $salary)
                <option class="text-capitalize"
                    :selected="{{ isset($internship) ? ($internship->salary_id == $salary->id ? 'true' : 'false') : 'false' }}"
     ...
     <!-- Deadline Field -->
     <div class="form-group col-sm-6">
        {!! Form::label('deadline', 'Internship Deadline:') !!}
        <div class="form-group">
            <input type="date" value="{{ isset($internship) ? $internship->deadline : null }}" class="form-control mb-2"
                name="deadline">
        </div>
    </div>

    <text-editor inline-template description="{{ isset($internship) ? $internship->description : null }}">
    ...
    <div class="form-group col-sm-12">
        ...
        <a href="{{ route('shared.internships.index') }}" class="btn btn-secondary">Cancel</a>
    </div>
